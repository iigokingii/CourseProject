...
CREATE OR REPLACE PACKAGE BODY ADMINFILMFUNCTIONS AS
    ...
    BEGIN
        OPEN V_FILM_CURSOR FOR
            SELECT ALL_INFORMATION_ABOUT_FILM.*,USERS_REVIEWS_ON_MOVIE.USER_REVIEW_TEXT,USERS_REVIEWS_ON_MOVIE.DATE_OF_REVIEW,USER_PROFILE.LOGIN,USER_PROFILE.AVATAR,USER_PROFILE.USER_ROLE
                FROM ALL_INFORMATION_ABOUT_FILM
